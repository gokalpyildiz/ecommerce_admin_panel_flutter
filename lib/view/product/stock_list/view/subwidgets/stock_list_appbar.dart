...
class StockListAppbar extends StatelessWidget with UIMixin {
  const StockListAppbar({
    super.key,
  });
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      MyText(
                        'Bu sayfadan istediğiniz ürüne stok listesi tanımlayabilir ve değişiklik yapabilirsiniz',
                      ),
                    ],
                  ),
                ),
              ...
              child: Row(
                children: [
                  ...
                  MyButton(
                    elevation: 0,
                    onPressed: () {
                      Get.toNamed(AppPages.addStokList);
                    },
